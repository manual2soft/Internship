...
const AISearchModal = () => {
  ...
  const exampleText = [
    ...
    "Bluetooth speaker with loud sound for outdoor use",
    "Best phone for photography under ₹20000",
    "Comfortable office chair for long hours",
    "Mechanical keyboard for coding and gaming",
    "Affordable gym accessories for home workout",
    "Trendy sneakers for daily wear under ₹2500",
    "Portable power bank with fast charging",
    "Noise cancelling earphones for travel"
  ];
