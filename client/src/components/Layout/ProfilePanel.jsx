      ...
      <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto">
        ...
        <div className="p-6">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full p-2 rounded border-border bg-secondary text-foreground"
                />
                <input
                  type="email"
          ...
          <button
            ...
            className="my-6 flex justify-center items-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover text-destructive hover:text-destructive-foreground group w-full"
          >
